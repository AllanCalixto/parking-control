...
public class ParkingSpotController {
    ...
    @PostMapping
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid @NotNull ParkingSpotDto parkingSpotDto) {
        ...
        if(parkingSpotService.existsByParkingSpotNumber(parkingSpotDto.getParkingSpotNumber())) {
            return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflict: Parking Spot is a already in use!");
        }
    ...
    public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id, @RequestBody @Valid ParkingSpotDto parkingSpotDto) {
        ...
        var parkingSpotModel = new ParkingSpotModel();
        BeanUtils.copyProperties(parkingSpotDto, parkingSpotModel);
        parkingSpotModel.setUid(parkingSpotModelOptional.get().getUid());
